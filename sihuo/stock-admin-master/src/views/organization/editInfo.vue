  ...
  <div class="organization-page">
    ...
    <div class="content">
      <el-form ref="ruleForm" :model="form" :rules="rules" label-width="130px" class="demo-ruleForm">
        ...
        <el-form-item label="类型" prop="operationalTypes">
          <el-select v-model="form.operationalTypes" multiple filterable placeholder="请选择类型" style="width:100%;">
            <el-option
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      if(form.operationalCurrencyAmount) {
          form.operationalCurrencyAmount = form.operationalCurrencyAmount * 10000
        }
        if(form.noOperationalTotalAmount) {
          form.noOperationalTotalAmount = form.noOperationalTotalAmount * 10000
        }
        if(form.operationalFixedAmount) {
          form.operationalFixedAmount = form.operationalFixedAmount * 10000
        }
