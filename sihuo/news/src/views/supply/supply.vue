<template>
  <div>
    ...
    <div class="flex" style="margin-top:10px;">
      ...
      <el-button type="primary" @click="supplySearch">搜索</el-button>
    </div>
    <el-table
      :data="supplyInfos"
...
import { getCirculateType, getProjectType, getAreaIntervalType, getPriceIntervalType, getTimeIntervalType, supplySearch } from '@/api/supply'
export default {
  components: {
    Pagination,
  },
  ...
  methods: {
    ...
    supplySearch() {
      supplySearch({
        ...
        this.supplyInfos = res.data.supplyInfos
      })
    },
    handleRowClick(row) {
      this.$router.push({
