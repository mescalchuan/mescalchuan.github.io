    ...
    E.plugin(function () {
        ...
        fns.onload || (fns.onload = function (resultText, xhr) {
            ...
            if (resultText.indexOf('error|') === 0) {
                ...
                img.onload = function () {
                    var html = '<img src="' + JSON.parse(resultText).data.data[0] + '" alt="' + originalName + '" style="max-width:100%;"/>';
                    editor.command(null, 'insertHtml', html);

                    E.log('已插入图片，地址 ' + JSON.parse(resultText).data.data[0]);
                    img = null;
                };
                ...
                img.src = JSON.parse(resultText).data.data[0];
            }
